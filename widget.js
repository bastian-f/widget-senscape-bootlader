...
cpdefine("inline:com-senscape-widget-bootloader", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        ...
        //    chilipeppr.publish("/com-chilipeppr-widget-serialport/send", "test\n");
            chilipeppr.publish("/com-chilipeppr-widget-serialport/send", "C045040A0000FF080123456789ABCDEFD08EC0");
        },
        /**
         * onTomcatBtnClick is an example of a button click event callback
         */
        ...
        onRecvLine: function(data) {
            ...
            console.error("firstCs: " + data.dataline.substring(0,2));
            console.error("compare: " + data.dataline.substring(0,2).localeCompare("c0"));
            if (data.dataline.substring(0,2).localeCompare("c0")) {
                console.error("valid data!");
                chilipeppr.publish("/com-chilipeppr-widget-serialport/send", data.dataline.trim());
            }
